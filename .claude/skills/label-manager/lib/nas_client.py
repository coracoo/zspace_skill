...
为什么要这个文件:
  ...
  - 直接 `from mcp_server import NasClient` 会触发这些初始化(实测 0.77s 冷启动,可接受)
...
env 加载顺序:
  ...
  - 所以 _load_env() 放在 from mcp_server import 之前
"""
import os
import sys
...
from mcp_server import NasClient, _to_json  # noqa: E402
